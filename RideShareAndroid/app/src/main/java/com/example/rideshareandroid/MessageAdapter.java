...
// ahi drawable user add karvo
                Picasso.get().load(image)
                        .placeholder(R.drawable.googleg_standard_color_18).into(viewHolder.profileImage);
...
// ahi drawable user add karvo
            ...
            Picasso.get().load(c.getMessage())
                    .placeholder(R.drawable.googleg_standard_color_18).into(viewHolder.messageImage);
